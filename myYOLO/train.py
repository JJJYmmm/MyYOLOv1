...
def parse_args():
    ...
    parser.add_argument('--save_folder', default='~/d2l/weights/', type=str,
    ...
    parser.add_argument('-d', '--dataset', default='voc',
                        help='voc or coco')
    parser.add_argument('--root', default='~/d2l/data',
                        help='data root')
...
def train():
    ...
    dataset, num_classes, evaluator = build_dataset(
        args, device, train_size, val_size)
    ...
    if args.tfboard:
        ...
        log_path = os.path.join('./', args.version, c_time)
    ...
    for epoch in range(args.start_epoch, max_epoch):
        ...
        for iter_i, (images, targets) in enumerate(dataloader):
            ...
            # 前向推理和计算损失
            conf_loss, cls_loss, bbox_loss, total_loss = model(
